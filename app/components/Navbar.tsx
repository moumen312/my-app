  ...
  return (
    <nav className="flex items-center justify-between w-full"  style={{
      ...
      <Image
        ...
        className="ml-[26px] mt-[18px] mb-[18px]"
        priority  />
      
      {/* right side buttons */}
      <div className="transition-all mr-[40] text-white ">
        <a href="#" className='hover:brightness-125 text-[14px] font-medium leading-[22.4px] tracking-normal align-middle dmSans.className  text-[var(--authntication)] no-underline mr-[40px]'>Contact us</a>
